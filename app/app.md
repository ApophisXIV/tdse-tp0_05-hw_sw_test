...
En esta funcion se incrementa el contador de ticks global para la tarea c (que es bloqueante) y para la aplicacion en general al ritmo del `SysTick` (1 tick/ms)